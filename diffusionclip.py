...
class DiffusionCLIP(object):
    def __init__(self, args, config, device=None):
        ...
        self.finetuned_models = {"angry" : "", "makeup" : "", "sketch" : ""}
        # CLIP to 256 * 256 * 1
        self.CLIP_to_img = nn.Sequential(
            nn.Linear(self.text_encoding_size, self.compressed_text_size),
            nn.ReLU(),
    ...
    def clip_finetune_multi(self):
        ...
        # ----------- Optimizer and Scheduler -----------#
        print(f"Setting optimizer with lr={self.args.lr_clip_finetune}")
        # TODO: Add projection layer parameters
        addtional_params = list(self.CLIP_to_img.parameters()) + list(self.stack_to_input.parameters())
